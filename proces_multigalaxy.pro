pro proces_multigalaxy
  ...
  ; load data
  cd ,'/home/dhui890/Documents/Research/Brendon/DNest4/code/Examples/MultipleGalaxies/Data'
  dir = '/home/dhui890/Documents/Research/Brendon/DNest4/code/Examples/MultipleGalaxies/Data'
  ...
  cd ,'/home/dhui890/Documents/Research/Brendon/DNest4/code/Examples/MultipleGalaxies/'
  dir = '/home/dhui890/Documents/Research/Brendon/DNest4/code/Examples/MultipleGalaxies'
  
;  
  info_filename = dir + '/'   + 'sample.txt'
  temp_data = READ_ASCII(info_filename)
  file_data = temp_data.field00001
  ...
  xsize = s[1]
  ysize = s[2]
  img = file_data[0, 0:xsize*ysize-1]
  img = reform(img)
  img = reform(img, xsize, ysize)
  
  info_filename = dir + '/'   + 'posterior_sample.txt'
  temp_data = READ_ASCII(info_filename)
  file_data2 = temp_data.field000001
  file_data2 =  transpose(file_data)

  
 ;    FIELD000001     FLOAT     Array[122976, 3]


; Just a line add to test something in Python.     
; z =[' sigma ',' dim_components',' max_num_components',' location_log_period',' scale_log_period',' location_log_amplitude',' scale_log_amplitude',' num_components',' log_x[0]','log_x[1]','log_x[2]','log_y[0]','log_y[1]','log_y[2]','log_mag[0]','log_mag[1]','log_mag[2]','log_Re[0]','log_Re[1]','log_Re[2]','log_n[0]','log_n[1]','log_n[2]','log_q[0]','log_q[1]','log_q[2]','log_theta[0]','log_theta[1]','log_theta[2]','log_boxi[0]','log_boxi[1]','log_boxi[2]','log_mag-bar[0]','log_mag-bar[1]','log_mag-bar[2]','log_Rout[0]','log_Rout[1]','log_Rout[2]','log_a[0]','log_a[1]','log_a[2]','log_b[0]','log_b[1]','log_b[2]','log_q-bar[0]','log_q-bar[1]','log_q-bar[2]','log_theta-bar[0]','log_theta-bar[1]','log_theta-bar[2]','log_box-bar[0]','log_box-bar[1]','log_box-bar[2]']
;  max_comp
;  
